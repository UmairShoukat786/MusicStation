...
const music = [
  {
    ...
    image: require('../assets/images/popm.jpeg'),
  },
  {
    id: '2',
    ...
    image: require('../assets/images/popmus.jpeg'),
  },
  {
    id: '3',
    ...
    image: require('../assets/images/popmusi.jpeg'),
  },
  {
    id: '4',
    url: require('../assets/music/cheerful-music-for-short-video-vlog-stories-advertising-funny-promos-170013.mp3'),
    ...
    image: require('../assets/images/popmusic.jpeg'),
  },
  {
    id: '5',
    url: require('../assets/music/science-documentary-169621.mp3'),
    ...
    image: require('../assets/images/popmu.jpeg'),
  },
];
...
const PopMusic = () => {
  ...
  return (
    <LinearGradient colors={['rgba(56,56,56,0.7)','rgba(56,56,56,0.7)']} style={styles.container}>
      <FlatList
        ref={flatListRef}
        data={music}
...
const styles = StyleSheet.create({
  ...
  card: {
    display: 'flex',
    flexDirection: 'row',
    backgroundColor: 'rgba(53, 43, 45,0.7)',
    borderRadius: 10,
    padding: 10,
    marginTop: 20,
    marginLeft: 10,
